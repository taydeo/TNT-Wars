...
public class RegionManager {
	...
	private static int[][] lr = TNTWarsMain.configEngine.lobbyRegion;
	private static int[][] tor = TNTWarsMain.configEngine.teamOneIslandRegion;
	private static int[][] ttr = TNTWarsMain.configEngine.teamTwoIslandRegion;
